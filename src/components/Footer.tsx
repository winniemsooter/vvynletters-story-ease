      ...
      <div className="container mx-auto px-6">
        <div className="text-center space-y-6">
          <div>
            ...
            <p className="font-avenir text-background/80">
              Storytelling Meets Purpose
            </p>
          </div>
          
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm font-avenir">
          ...
          <div className="pt-6 border-t border-background/20">
            <p className="text-background/60 text-sm font-avenir">
